...
import React, { useState, useEffect } from 'react';
import EditProductFactory from './Factory/EditProductFactory';
...
const EditProduct = ({ product, onClose, fetchProducts }) => {
    ...
    const controller = EditProductFactory(setCategories, setLoading);
    ...
    const handleSubmit = async (e) => {
        ...
        const result = await controller.updateProduct(product, productData, imageFile);
